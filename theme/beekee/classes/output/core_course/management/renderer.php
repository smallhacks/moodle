...
/**
 * BEEKEE main renderer for the course management pages.
 *
 * @package    theme_beekee
 * @copyright  2019 Vincent Widmer, based on Boost and Moov themes
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class renderer extends \core_course_management_renderer {
    ...
    public function grid_column_start($size, $id = null, $class = null) {
        ...
        if ($id == 'course-detail') {
            ...
            $bootstrapclass = 'flex-wrap px-3 mb-3';
        }
    ...
    public function category_listing_actions(core_course_category $category = null) {
        ...
        if ($cancreatecategory) {
            ...
            $actions[] = html_writer::link($url, get_string('createnewcategory'), array('class' => 'mt-3 btn btn-primary'));
        }
    ...
    public function course_listing_actions(core_course_category $category, core_course_list_element $course = null, $perpage = 20) {
        ...
        if ($category->can_create_course()) {
            ...
            $actions[] = html_writer::link($url, get_string('createnewcourse'), array('class' => 'mt-3 btn btn-primary'));
        }
        ...
        // BEEKEE : hide sorting courses options and courses per page options
        // if ($category->can_resort_courses()) {
