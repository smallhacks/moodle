    ...
    function toggleClickHandler(node, nodename) {
        node.click(function(e) {
            ...
            if (node.attr('data-collapse') == 0) {
                ...
                M.util.set_user_preference('local_boostnavigation_beekee-collapse_' + nodename + 'node', 1);
                ...
                // Save this state to the user preferences.
                M.util.set_user_preference('local_boostnavigation_beekee-collapse_' + nodename + 'node', 0);
            }
        });
    }
